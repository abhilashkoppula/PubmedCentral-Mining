...
//						treePath.addNode((String) paperNode
//								.getProperty(Constants.PROPERTY_PUBMED_ID));
//						treePath.addEdge((double) rel
//								.getProperty(Constants.PROPERTY_WEIGHT));
//						treePath.addNode((String) citedNode
//								.getProperty(Constants.PROPERTY_PUBMED_ID));
//						treePath.addEdge((double) cite
//								.getProperty(Constants.PROPERTY_WEIGHT));
//						treePath.addNode((String) endKeywordNode
//								.getProperty(Constants.PROPERTY_KEYWORD));
//						treePath.addEdge((double) relOut
//								.getProperty(Constants.PROPERTY_WEIGHT));
//					}
//				}
//
